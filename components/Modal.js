...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // Create a post and add to Firesore 'posts' collection
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        ...
        onClose={setOpen}
      >
        <div className="flex items-center justify-center md:min-h-[800px] pt-4 px-4 pb-20 text-center min-h-screen  sm:block sm:p-0">
          <Transition.Child
            as={Fragment}
